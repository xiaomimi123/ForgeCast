...
export const RemotionRoot: FC = () => {
  return (
    <>
      ...
      <Composition id="Demo" component={asComp(Demo)} durationInFrames={1800} fps={30} width={1080} height={1920} defaultProps={defaultDemoProps as unknown as Record<string, unknown>} />
    </>
  )
}
